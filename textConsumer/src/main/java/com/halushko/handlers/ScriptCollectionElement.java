...
public enum ScriptCollectionElement {
    ...
    private static Map<String, ScriptCollectionElement> allCommands;

    ScriptCollectionElement(String command, String script, String queue) {
    ...
    public static Command getCommand(String text) {
        ...
        for(ScriptCollectionElement savedCommands: getCommandList()) {
    ...
    private static Collection<ScriptCollectionElement> getCommandList() {
        init();
    ...
    private static void init() {
        if (allCommands == null) {
            ...
            Map<String, ScriptCollectionElement> allCommandsTemp = new LinkedHashMap<>();
            ArrayList<ScriptCollectionElement> commands = new ArrayList<>(Arrays.asList(values()));
